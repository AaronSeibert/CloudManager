package com.binaryitsystems.cloudmanager.rackspace;
...
public class RackspaceMain {
    ...
    static {
        // Add 3 sample items.
        addItem(new ProviderService("1", "Test"));
        addItem(new ProviderService("2", "Service"));
        addItem(new ProviderService("3", "Now"));
    }
